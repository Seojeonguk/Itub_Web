...
start = machin(int(sys.args[0]), int(sys.args[1]), sys.args[2], 's_start')
during = machin(int(sys.args[0]), int(sys.args[1]), sys.args[2], 's_during')
temp = machin(int(sys.args[0]), int(sys.args[1]), sys.args[2], 's_temp')
