...
start = machin(sys.args[0], sys.args[1], sys.args[2], 's_start')
during = machin(sys.args[0], sys.args[1], sys.args[2], 's_during')
temp = machin(sys.args[0], sys.args[1], sys.args[2], 's_temp')
